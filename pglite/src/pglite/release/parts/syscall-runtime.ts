...
export const createSyscallImplementations = ({
	...
	var ___syscall__newselect = (nfds, readfds, writefds, exceptfds, timeout) => {
		try {
			...
			var check = (fd: any, low: any, high: any, val: any) =>
	...
	var bigintToI53Checked = (num: any) =>
