package io.github.hidekatsu_izuno.pglite_jdbc.pglite.pgtap;
...
public final class index {
    public static final Extension<Object> pgtap = new Extension<>();

    static {
        pgtap.name = "pgtap";
        pgtap.setup = (_pg, emscriptenOpts, clientOnly) -> {
            var result = new ExtensionSetupResult<Object>();
            result.emscriptenOpts = emscriptenOpts;
            result.bundlePath = resource("pgtap.tar.gz");
