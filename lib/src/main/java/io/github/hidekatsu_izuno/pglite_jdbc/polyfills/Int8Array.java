...
public class Int8Array implements TypedArray {
    ...
    public Int8Array(ArrayBuffer array) {
        this(array, 0, array.byteLength);
    }

    public Int8Array(ArrayBuffer array, int byteOffset, int length) {
    ...
    public void set(int index, int value) {
        ...
        this.buffer.bytes[this.byteOffset + index] = (byte) value;
    }

    public void set(Int8Array source) {
        this.set(source, 0);
    }

    public void set(Int8Array source, int offset) {
