package io.github.hidekatsu_izuno.pglite_jdbc.pglite.pg_uuidv7;
...
public final class index {
    public static final Extension<Object> pg_uuidv7 = new Extension<>();

    static {
        pg_uuidv7.name = "pg_uuidv7";
        pg_uuidv7.setup = (_pg, emscriptenOpts, clientOnly) -> {
            var result = new ExtensionSetupResult<Object>();
            result.emscriptenOpts = emscriptenOpts;
            result.bundlePath = resource("pg_uuidv7.tar.gz");
