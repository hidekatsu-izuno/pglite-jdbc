...
public class Int32Array implements TypedArray {
    ...
    public Int32Array(ArrayBuffer array) {
    ...
    public Int32Array(ArrayBuffer array, int byteOffset, int length) {
    ...
    public void set(Int32Array source) {
        this.set(source, 0);
    }

    public void set(Int32Array source, int offset) {
