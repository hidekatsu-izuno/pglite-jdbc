...
public class BigInt64Array implements TypedArray {
    ...
    public BigInt64Array(long[] array) {
        this(new ArrayBuffer(array.length * BYTES_PER_ELEMENT));
        this.set(array);
    }

    public BigInt64Array(ArrayBuffer array) {
    ...
    public BigInt64Array(ArrayBuffer array, int byteOffset, int length) {
    ...
    public void set(BigInt64Array source) {
        this.set(source, 0);
    }

    public void set(BigInt64Array source, int offset) {
