...
<project_layout>
- pglite/src: This Node.js programs are the original sources for the migration and must not be changed (excludes pglite/src/pglite-custom).
...
- For JavaScript Web Standard classes (excluding built-in classes), create polyfills and store them under io.github.hidekatsu_izuno.pglite_jdbc.polyfill.
